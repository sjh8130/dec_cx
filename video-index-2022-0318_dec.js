...
function loadVideo() {
	...
	var isVideoVisibleName = parent.isVideoVisibleName
		, doublespeed = data ? data.doublespeed != 0 ? 1 : 0 : 1;
	...
	function request() {
		percent <= 0x64 && hl.setWidth((percent += 5) + '%');
		var k = getCookie('fid') || '';
		Ext.Ajax.request({
				...
				for (var _0x4612c6 = 0, _0x443b90 = _0x386360.length; _0x4612c6 < _0x443b90; _0x4612c6++) {
					...
					if (_0x5b2f15 == _0x4237fa) {
						if (st == 0)
							...
							st == 1 ? _0x1fa814 = _0x3c3c35.enc1 : _0x1fa814 = _0x3c3c35.enc2;
						break;
					}
				}
...
Ext.onReady(function () {
	...
	if (_0xdb141 && _0xdb141 == 1) {
		var _0x186bae = '<img src=\x22/ananas/css/downgradeBlueTip.jpg\x22 width=\x22676\x22\ height=\x22540\x22>';
