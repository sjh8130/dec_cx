				...
				loadMultiFile(
						...
						function() {
							var mp = new MoocPlayer({
								'isSendLog': !!parent.AttachmentSetting &&
										parent.AttachmentSetting.control,
								'data': paras,
								'height': 540,
								'width': 676
							});
...
function showHTML5Player(paras) {
	...
	function changePPTTop() {
		var videoHeight = $('#video').height(),
				...
				topHeight = (parseInt(videoHeight) - 60 - parseInt(picHeight)) / 2;
		$('#sp_video_ppt_pic').length > 0 &&
						$('#sp_video_ppt_pic').hasClass('sp_ppt_pic_fullScreen') ?
...
function loadVideo() {
	...
	var iframe = window.frameElement,
			...
			setting = parent.AttachmentSetting, mid = config('mid'), _0x26080a = 0,
			vbegin = config('vbegin'), _0x265c73 = config('vend'),
			_0x264973 = config('jobid') || '',
			_0x281396 = data ? data.danmaku == null ? 0 : data.danmaku : 0,
			_0x5213d7 = setting && setting.videoTopicCloud,
			_0x4619f5 = config('fastforward') == 'true' ? true : false,
			_0x348ae6 = config('switchwindow') == 'true' ? true : false,
			_0xc4e313 = Ext.get('note'), _0xeae2e1 = Ext.get('hl'),
			_0x49428f = Ext.get('note1-wrap'), _0x26916b = Ext.get('note1'),
			_0x53d966 = null, _0xdaeeef = data ? data.rt ? data.rt : 0.9 : 0.9;
	_0x264973 == '' ? videoJobId = data && data['_jobid'] ? data['_jobid'] : '' : videoJobId = _0x264973;
	var _0x3f5d8c = flashChecker().hasFlash;
	try {
		isTeacher = top.location.href.indexOf('teacherstudy') > 0 ||
				top.location.href.indexOf('course/phone/chapterdata') > 0;
	} catch (_0x16add9) {
	}
	var _0x40b6e9 = parent.isVideoVisibleName,
			_0x24a749 = data ? data.doublespeed != 0 ? 1 : 0 : 1;
	...
	function _0xd991da(_0xafaa22) {
		...
		if (Ext.select('.zsCloud_ul') != null) {
			var _0x468ddb = '';
			for (var _0x124454 = 0, _0x3e8e87 = _0xafaa22.length;
					 _0x124454 < _0x3e8e87; _0x124454++) {
				_0x468ddb += '<li><span class=\'topicId' + _0xafaa22[_0x124454].id +
						'\' onclick=\'markersPlayer(this)\'>' + _0xafaa22[_0x124454].name +
						' </span></li>';
			}
	...
	function _0x44b806() {
		...
		Ext.Ajax.request({
			'url': '/ananas/status/' + objectid + '?k=' + _0x1b0e22 + '&flag=normal',
			'success': function(_0x23be19) {
				var _0x309ab2 = eval('(' + _0x23be19.responseText + ')');
				Ext.get('loading').hide();
				switch (_0x309ab2.status) {
					case 'success':
						_0x49428f.remove(), videoName = data && data.name || '';
						_0x40b6e9 != 'false' &&
								(Ext.fly(window.frameElement).parent().first('.ans-job-icon') !=
												 null ?
										 Ext.fly(window.frameElement)
												 .parent()
												 .first('.ans-job-icon')
												 .insertHtml(
														 'beforeEnd',
														 '<span title="' + videoName +
																 '" style="width: 500px;margin-left: 120px;display: inline-block;height: 23px;line-height: 23px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">' +
																 videoName + '</span>') :
										 Ext.fly(window.frameElement)
												 .parent()
												 .insertHtml(
														 'afterBegin',
														 '<div title="' + videoName +
																 '" style="width: 500px;display: inline-block;line-height: 23px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;">' +
																 videoName + '</div>'));
						...
						if (document.cookie.length > 0) {
							...
							_0x5678df.questionErrorLogUrl =
									ServerHosts.MASTER_HOST + '/question/addquestionerror';
						}
						mid && (_0x5678df.mid = mid);
						_0x309ab2.duration &&
								(_0x5678df.videoTotalTime = _0x309ab2.duration);
						if (setting && setting.isErya == 1) {
							_0x5678df.screenshot =
									'https://p.ananas.chaoxing.com/star3/origin/a26e16b5ac8e769bba6bda57343b7d57.png';
						} else {
							_0x309ab2.screenshot &&
									(_0x5678df.screenshot = _0x309ab2.screenshot);
						}
						setting &&
								(_0x5678df.chapterVideoTranslate =
										 setting.chapterVideoTranslate);
						_0x309ab2.thumbnails &&
								(_0x5678df.thumbnails = _0x309ab2.thumbnails);
						_0x309ab2.subobjectid &&
								(_0x5678df.subobjectid = _0x309ab2.subobjectid);
						vbegin && (_0x5678df.startTime = vbegin);
						_0x265c73 && (_0x5678df.endTime = _0x265c73);
						_0x5678df.rt = _0xdaeeef,
						_0x5678df.control = setting && setting.control;
						isTeacher && (_0x5678df.control = false);
						var _0x30ea28 = {}, _0x14905a, _0x194a32, _0x16581e;
						if (setting && setting.control) {
							var _0xf0b1fd = setting.attachments, _0x31c287 = setting.defaults,
									_0x43dbd6 = _0x309ab2.objectid + '-' + (vbegin ? vbegin : 0) +
									'-' + (_0x265c73 ? _0x265c73 : _0x462c67) + '-' + _0x264973;
							_0x31c287 &&
									(_0x5678df.userid = _0x31c287.userid || '',
									 _0x5678df.fid = _0x31c287.fid || '');
							for (var _0x17b6ad = 0; _0x17b6ad < _0xf0b1fd.length;
									 _0x17b6ad++) {
								_0x30ea28 = _0xf0b1fd[_0x17b6ad];
								_0x194a32 = 0;
								_0x16581e = _0x462c67;
								_0x30ea28.property &&
										(_0x30ea28.property.vbegin &&
												 (_0x194a32 = _0x30ea28.property.vbegin),
										 _0x30ea28.property.vend &&
												 (_0x16581e = _0x30ea28.property.vend));
								!_0x30ea28.jobid && (_0x30ea28.jobid = '');
								_0x14905a = _0x30ea28.objectId + '-' + _0x194a32 + '-' +
										_0x16581e + '-' + _0x30ea28.jobid;
								if (_0x43dbd6 == _0x14905a) {
									Ext.apply(_0x5678df, setting.defaults);
									_0x5678df.headOffset = _0x30ea28.headOffset ?
											Math.floor(parseInt(_0x30ea28.headOffset) / 1000) :
											0;
									...
									_0x30ea28.property && _0x30ea28.property.fastforward &&
											_0x30ea28.property.fastforward == 'true' &&
											(_0x5678df.enableFastForward = 0);
									_0x30ea28.property &&
											typeof _0x30ea28.property.doublespeed != 'undefined' &&
											_0x30ea28.property.doublespeed == 0 &&
											(_0x5678df.doublespeed = 0, _0x24a749 = 0);
									var _0xe15a64 = _0x5678df.schooldoublespeed;
									typeof _0xe15a64 == 'undefined' || _0xe15a64 == 2 ?
											_0x5678df.doublespeed = _0x24a749 :
											_0x5678df.doublespeed = _0xe15a64;
									_0x264973 &&
											(_0x5678df.jobid = _0x264973,
											 !_0x30ea28.job &&
													 (!isTeacher && greenligth(), ed_complete = false,
														_0x5678df.enableFastForward = 1,
														_0x5678df.enableSwitchWindow = 1,
														_0x5678df.headOffset = 0));
									_0x5678df.reportUrl = _0x5678df.reportUrl &&
											_0x5678df.reportUrl.replace(
						...
						(!_0x5678df.control || isTeacher) &&
								(ed_complete = false, _0x5678df.enableFastForward = 1,
								 _0x5678df.enableSwitchWindow = 1, _0x5678df.headOffset = 0);
						(_0x5678df.isPassed ||
						 _0x5678df.headOffset > _0x5678df.videoTotalTime * 0.95) &&
								(_0x5678df.headOffset = 0);
						_0x53d966 && clearInterval(_0x53d966),
								_0x5678df.isSupportFace =
										$('.maskDiv1', top.document).length > 0 &&
										/\/studentstudy/.test(top.location.pathname) ?
								true :
								false,
								_0x5678df.isShowFaceCollection =
										/\/studentstudy/.test(top.location.pathname) &&
								!Ext.fly(window.frameElement)
										 .parent()
										 .hasCls('ans-job-finished');
						if (supportH5Video()) {
							data.danmaku &&
									(loadMultiFile(
											 [{
							...
							if (!_0x3f5d8c) {
								...
								Ext.get('reader').setHTML(
										'您没有安装flashplayer\uFF0C请到<a href="' + _0x1f7517 +
						...
						break;
					case 'failed':
						_0x53d966 && clearInterval(_0x53d966), _0x49428f.remove(),
								_0xc4e313.show();
						break;
					case 'waiting':
						_0x49428f.update(
								'<div class="line1"><div class="line3"></div></div><p class="tipStyle making">视频正在转码\uFF0C您无需在此页面等待\u30109001\u3011</p>');
						break;
					case 'converting':
					case 'transfer':
						_0x49428f.update(
								'<div class="line1"><div class="line2"></div></div><p class="tipStyle">视频上传中\u30109002\u3011</p>');
						break;
				}
			},
			'failure': function(_0x28181e) {
				_0x28181e.status == 0 ?
						(_0x53d966 && clearInterval(_0x53d966),
						 _0x49428f.update(
								 '<div class="line1"><div class="line2"></div></div><p class="tipStyle">视频加载超时\uFF0C请刷新页面重试\u30109003\u3011</p>'),
						 Ext.get('loading').hide()) :
						(_0x53d966 && clearInterval(_0x53d966),
						 _0x49428f.update(
								 '<div class="line1"><div class="line3"></div></div><p class="tipStyle">视频加载失败\uFF0C请稍后再试\u30109004\u3011</p>'),
						 Ext.get('loading').hide());
			}
		});
	}
...
function supportH5Video() {
	var _0x6aeaaa = function() {
		...
		if (typeof _0x41c4a5.canPlayType == 'function') {
			var _0x4f069c =
					_0x41c4a5.canPlayType('video/mp4;codecs="avc1.42E01E,mp4a.40.2"');
			if (_0x4f069c.toLowerCase() == 'maybe' ||
					_0x4f069c.toLowerCase() == 'probably') {
				return true;
			}
			var _0x4f069c =
					_0x41c4a5.canPlayType('video/mp4;codecs="avc1.64001E,mp4a.40.2"');
			if (_0x4f069c.toLowerCase() == 'maybe' ||
					_0x4f069c.toLowerCase() == 'probably') {
				return true;
			}
...
function sendReadZTMediaLog(_0x18fbc6) {
	try {
		var _0x5d72c4 =
						function(_0x3de9ed) {
			var _0x3aa9cf = new RegExp('(^|&)' + _0x3de9ed + '=([^&]*)(&|$)'),
					_0x2e5eb0 = parent.location.search.substr(1).match(_0x3aa9cf);
			if (_0x2e5eb0 != null) {
				return unescape(_0x2e5eb0[2]);
			}
			return null;
		},
				_0x192651 = parent.AttachmentSetting, _0x4183cc = window.frameElement,
				_0x34617c =
						_0x4183cc.parentElement.parentElement.parentElement.getAttribute(
								'kid');
		if (_0x34617c) {
		...
		var _0x2b5975 = _0x192651.defaults.isFiled,
				_0x1cf8d3 = _0x192651.defaults.state;
		if (_0x2b5975 == 1 || _0x1cf8d3 == 1) {
			return;
		}
		var _0x3b5837 = top.dtype || 'Course';
		if (_0x3b5837 == 'ZT' || _0x3b5837 == 'HB' || _0x3b5837 == 'MAG') {
			var _0x47b016 = parent.location.search || '',
					_0x9ab180 = getCookie('UID'), _0x153b3a = config('objectid'),
					_0x235b32 = 0, _0x2d694b = _0x192651.defaults.courseid,
					_0x14e7f4 = _0x192651.defaults.knowledgeid,
					_0x49508f = window.duration, _0xbe6748 = _0x5d72c4('_from_'),
					_0x8d819 = _0x192651.attachments, _0x4e5f66 = '';
			if (_0x8d819.length > 0) {
				for (var _0x2a25f9 = 0, _0x51100c = _0x8d819.length;
						 _0x2a25f9 < _0x51100c; _0x2a25f9++) {
					var _0xe00c88 = _0x8d819[_0x2a25f9], _0x422c86 = _0xe00c88.objectId;
					if (_0x422c86 == _0x153b3a) {
						if (_0x18fbc6 == 0) {
							_0x4e5f66 = _0xe00c88.enc0;
						} else {
							_0x18fbc6 == 1 ? _0x4e5f66 = _0xe00c88.enc1 :
															 _0x4e5f66 = _0xe00c88.enc2;
						}
						break;
					}
				}
			}
			var _0x188913 = location.protocol +
					'//data-xxt.aichaoxing.com/analysis/datalog?s=' + _0x2d694b +
					'&c=' + _0x14e7f4 + '&o=' + _0x153b3a + '&st=' + _0x18fbc6 +
					'&m=' + _0x235b32 + '&d=' + _0x49508f * 1000 + '&u=' + _0x9ab180 +
					'&_from_=' + _0xbe6748 + '&enc=' + _0x4e5f66,
					_0x191267 = function() {
						Ext.Ajax.request(
								{'url': _0x188913, 'success': function(_0x5cf289) {}});
					};
			_0x191267();
			if (_0x18fbc6 == 1) {
...
function receiveStudyLog() {
	try {
		...
		if (_0x362835 && _0x362835.defaults) {
			...
			var _0x41c4a9 = '/keeper/api/receive-studylog',
					_0x336a5f = new Date().getTime(), _0x322cc9 = _0x53d020.courseid,
					_0x22bcda = _0x53d020.clazzId, _0x50c402 = _0x53d020.cpi,
					_0x1ffbad = _0x53d020.userid, _0x44c2d8 = _0x53d020.knowledgeid,
					_0x3f6092 = _0x53d020.fid, _0x4aac66 = '',
					_0x4ce411 = config('objectid'), _0x517600 = config('jobid') || '',
					_0x598e13 = _0x362835.attachments;
			if (_0x598e13.length > 0) {
				for (var _0x2a0ce9 = 0, _0x39acc6 = _0x598e13.length;
						 _0x2a0ce9 < _0x39acc6; _0x2a0ce9++) {
			...
			Ext.Ajax.request({
				'method': 'post',
				'url': _0x41c4a9,
				'params': {'log': JSON.stringify(_0x4f245f), 'enc': _0x133d02},
...
function createVideoTask() {
	...
	var _0x5761a1 = location.protocol +
			'//convertservice.chaoxing.com/video/createVideoTask?objectid=' +
			wrongObj;
	Ext.Ajax.request({
		'timeout': 3000,
		'type': 'get',
...
Ext.onReady(function() {
	...
	if (_0x56a748 && _0x56a748 == 1) {
		var _0x3822c3 =
				'<img src="/ananas/css/downgradeBlueTip.jpg" width="676" height="540">';
...
function getDanmuByTime(_0x76ec7c, _0x4edabf) {
	...
	if (_0x32ee39 && _0x32ee39.defaults) {
		var _0x369d0c = _0x32ee39.defaults, _0x137863 = _0x369d0c.courseid,
				_0x3b0974 = _0x369d0c.clazzId;
	} else {
		return;
	}
	if (_0x76ec7c == 'pause') {
...
function danmuPlay(time) {
					...
					if (list[i] == '@疑惑@') {
						...
						if (list[i] == '@献花@') {
							...
							if (list[i] == '@鼓掌@') {
								...
								list[i] == '@有趣@' ?
										content +=
										'<span><i class="interestingIcon"></i>有趣</span>' :
	...
	content += '</div>';
	var r = count % 3,
			el = new Ext.XTemplate(content).append('channel_' + r);
	shotdanmu(el);
	count++;
}
var getPlayState;
	...
	if (/\/studentstudy/.test(top.location.pathname)) {
		...
		if (len > 0) {
			...
			getPlayState = setInterval(function() {
				top.playerState &&
						(clearStateInterval(), obj.isPlay = true, player.play(),
...
Ext.onReady(function() {
	...
	$('.writeNote').click(function() {
		...
		var cPlayer = videojs('video'),
				videoTime = parseInt(cPlayer.currentTime()),
				minuteTime = parseInt(videoTime / 60);
		minuteTime < 10 && (minuteTime = '0' + minuteTime.toString());
		var secondTime = parseInt(videoTime % 60);
		secondTime < 10 && (secondTime = '0' + secondTime.toString());
		$('.Note_name', parent.parent.document)
				.html(videoName + ' ' + minuteTime + ':' + secondTime);
		...
		$('.formTopic', parent.parent.document).size() > 0 &&
